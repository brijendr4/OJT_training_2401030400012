...
export default function Checkout() {
  ...
  async function submit(e) {
    ...
    try {
      ...
      const payload = {
        items: orderItems,
        total,                  // Server will re-verify this
  ...
  if (order) return (
    <div className="container-main py-16">
      <div className="shadow-soft p-12 text-center max-w-md mx-auto bg-primary">
        ...
        <div className="shadow-inset p-4 mb-6 bg-primary rounded-xl">
          <div className="text-[10px] text-zinc-400 uppercase tracking-widest font-black">Order ID</div>
          <div className="text-sm font-mono text-zinc-800 font-bold mt-1.5 break-all">{order._id}</div>
        </div>
  ...
  return (
    <div className="container-main py-10">
      ...
      <form onSubmit={submit} className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        {/* Shipping form */}
        <div className="shadow-soft p-6 space-y-4 bg-primary rounded-2xl">
